...
const PAGES = [
  ["index.html", "Hem"], ["katalog.html", "Katalog"], ["skapa.html", "Skapa"],
  ["linnea.html", "Linnea"], ["minne.html", "Minne"], ["pack.html", "Pack"],
  ["ai.html", "AI"], ["azure.html", "Azure"], ["kopplingar.html", "Kopplingar"],
  ["bevakning.html", "Bevakning"], ["om.html", "Om"]
];
requireWorkshop();
...
if (header) header.innerHTML = `<div class="av" role="img" aria-label="Linnea"></div><div><strong>Free-Plugins</strong><span>Linnea · delat minne · verkstad</span></div><nav class="main" aria-label="Sajt">${nav}</nav>`;
